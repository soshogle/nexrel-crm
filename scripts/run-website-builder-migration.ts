#!/usr/bin/env tsx
/**
 * Run Website Builder Migration Directly via SQL
...
async function main() {
  console.log('🔄 Running Website Builder migration directly via SQL...\n');
  ...
  try {
    ...
    // Handle multi-line statements properly by splitting on semicolons that end a line or are followed by newline
    ...
    console.log('🎉 Website Builder migration process completed successfully!');
    console.log('\n📋 Next steps:');
    console.log('   1. Set environment variables (GITHUB_TOKEN, NEON_API_KEY, VERCEL_TOKEN)');
    console.log('   2. Test website creation at /dashboard/websites');
    console.log('   3. Verify tables in Prisma Studio: npx prisma studio\n');
  } catch (error: any) {
