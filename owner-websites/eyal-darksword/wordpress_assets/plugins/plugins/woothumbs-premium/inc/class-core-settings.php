...
class Iconic_WooThumbs_Core_Settings {
	...
	public static function get_plugin_slug() {
		return str_replace( '-', '_', 'iconic-woothumbs' );
	}
	...
	public static function support_link() {
		...
		return sprintf(
			...
			esc_url($url),
			esc_html__( 'Submit Ticket', 'iconic-woothumbs' ) );
	}
	...
	public static function documentation_link() {
		...
		return sprintf(
			'<a href="%s" class="button button-secondary" target="_blank">%s</a>',
			$url,
			esc_html__( 'Read Documentation', 'iconic-woothumbs' )
		);
	}
	...
	public static function account_link() {
		...
		return sprintf(
			'<a href="%s" class="button button-secondary" target="_blank">%s</a>',
			esc_url($url),
			esc_html__( 'Manage Your Account', 'iconic-woothumbs' )
		);
	}
	 ...
	 * @return string
	 */
	protected static function add_utm_query_args($url, $campaign, $medium = 'Plugin', $content = 'iconic-woothumbs', $source = null) {
		$args = [
