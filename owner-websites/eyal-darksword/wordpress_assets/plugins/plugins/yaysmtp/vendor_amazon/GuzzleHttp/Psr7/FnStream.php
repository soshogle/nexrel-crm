...
class FnStream implements \YaySMTP\Aws3\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\YaySMTP\Aws3\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
