...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \FSProVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
    ...
    public function stringify($fields)
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FSProVendor\Monolog\Utils::jsonEncode($normalized, $prettyPrintFlag | $flags) : \FSProVendor\Monolog\Utils::jsonEncode($normalized, $flags);
    }
    /**
     * Sets the formatter
     *
