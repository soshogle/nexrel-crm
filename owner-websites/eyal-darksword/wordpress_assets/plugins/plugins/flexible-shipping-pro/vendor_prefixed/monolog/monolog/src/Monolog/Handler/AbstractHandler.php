 ...
 */
abstract class AbstractHandler implements \FSProVendor\Monolog\Handler\HandlerInterface, \FSProVendor\Monolog\ResettableInterface
{
    protected $level = \FSProVendor\Monolog\Logger::DEBUG;
