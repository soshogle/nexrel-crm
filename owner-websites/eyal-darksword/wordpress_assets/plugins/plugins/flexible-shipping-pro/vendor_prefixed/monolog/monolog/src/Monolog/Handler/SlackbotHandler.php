 ...
 */
class SlackbotHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FSProVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
