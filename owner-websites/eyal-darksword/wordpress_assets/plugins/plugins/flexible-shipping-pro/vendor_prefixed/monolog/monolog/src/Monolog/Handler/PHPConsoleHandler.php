...
use FSProVendor\PhpConsole\Handler;
...
class PHPConsoleHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @throws Exception
     */
    public function __construct(array $options = array(), \FSProVendor\PhpConsole\Connector $connector = null, $level = \FSProVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    private function initConnector(\FSProVendor\PhpConsole\Connector $connector = null)
    {
        if (!$connector) {
