...
class PushoverHandler extends \FSProVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct($token, $users, $title = null, $level = \FSProVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \FSProVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \FSProVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
