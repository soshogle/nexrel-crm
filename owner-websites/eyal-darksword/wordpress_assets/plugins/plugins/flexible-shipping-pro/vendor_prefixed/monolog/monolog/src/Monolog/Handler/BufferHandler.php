 ...
 */
class BufferHandler extends \FSProVendor\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\FSProVendor\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \FSProVendor\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {
