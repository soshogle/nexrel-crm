...
use FSProVendor\RollbarNotifier;
use Exception;
...
class RollbarHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(\FSProVendor\RollbarNotifier $rollbarNotifier, $level = \FSProVendor\Monolog\Logger::ERROR, $bubble = \true)
    {
