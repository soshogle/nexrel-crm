...
class Logger implements \Psr\Log\LoggerInterface, \FSProVendor\Monolog\ResettableInterface
{
     ...
     * @return $this
     */
    public function pushHandler(\FSProVendor\Monolog\Handler\HandlerInterface $handler)
    {
    ...
    {
        if (!$this->handlers) {
            $this->pushHandler(new \FSProVendor\Monolog\Handler\StreamHandler('php://stderr', static::DEBUG));
        }
    ...
    public static function getLevelName($level)
    {
        if (!isset(static::$levels[$level])) {
            throw new \FSProVendor\Psr\Log\InvalidArgumentException('Level "' . $level . '" is not defined, use one of: ' . \implode(', ', \array_keys(static::$levels)));
        }
