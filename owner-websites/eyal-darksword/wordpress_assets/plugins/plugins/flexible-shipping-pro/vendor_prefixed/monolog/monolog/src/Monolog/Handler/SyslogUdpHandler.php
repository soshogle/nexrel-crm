...
class SyslogUdpHandler extends \FSProVendor\Monolog\Handler\AbstractSyslogHandler
{
     ...
     */
    public function __construct($host, $port = 514, $facility = \LOG_USER, $level = \FSProVendor\Monolog\Logger::DEBUG, $bubble = \true, $ident = 'php', $rfc = self::RFC5424)
    {
        parent::__construct($facility, $level, $bubble);
        $this->ident = $ident;
        $this->rfc = $rfc;
        $this->socket = new \FSProVendor\Monolog\Handler\SyslogUdp\UdpSocket($host, $port ?: 514);
    }
