 ...
 */
class OptInNotice implements \FSProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $plugin_slug, string $shop_url, \FSProVendor\Octolize\Tracker\OptInNotice\ShouldDisplay $should_display)
    {
    ...
    protected function create_notice()
    {
        ...
        new \FSProVendor\WPDesk\Notice\PermanentDismissibleNotice($this->prepare_notice_content(), $notice_name, \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS);
    }
    /**
     * @return string
     */
