 ...
 */
abstract class BasicField implements \FSProVendor\WPDesk\Forms\Field
{
    ...
    {
        $chain = new \FSProVendor\WPDesk\Forms\Validator\ChainValidator();
        if ($this->is_required()) {
            $chain->attach(new \FSProVendor\WPDesk\Forms\Validator\RequiredValidator());
        }
        return $chain;
    }
    ...
    {
        return new \FSProVendor\WPDesk\Forms\Sanitizer\NoSanitize();
    }
    /**
     * @return Serializer
     */
    ...
    {
        if (isset($this->meta['serializer']) && $this->meta['serializer'] instanceof \FSProVendor\WPDesk\Forms\Serializer) {
            return $this->meta['serializer'];
        }
        return new \FSProVendor\WPDesk\Forms\Serializer\NoSerialize();
    }
    public function set_serializer(\FSProVendor\WPDesk\Forms\Serializer $serializer)
    {
