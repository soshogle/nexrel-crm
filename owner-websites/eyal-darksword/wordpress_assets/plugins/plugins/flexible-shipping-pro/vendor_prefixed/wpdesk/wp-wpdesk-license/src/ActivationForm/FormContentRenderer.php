...
class FormContentRenderer
{
     ...
     */
    public function __construct(\FSProVendor\WPDesk_Plugin_Info $plugin_info, bool $update_possible, array $errors = [])
    {
    ...
    {
        $plugin_license = new \FSProVendor\WPDesk\License\PluginLicense($this->plugin_info);
