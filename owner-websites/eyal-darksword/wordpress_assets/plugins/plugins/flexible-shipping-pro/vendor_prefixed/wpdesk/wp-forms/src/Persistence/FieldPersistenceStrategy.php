...
class FieldPersistenceStrategy
{
    ...
    private $persistence;
    public function __construct(\FSProVendor\WPDesk\Persistence\PersistentContainer $persistence)
    {
     ...
     * @param array $data
     */
    public function persist_fields(\FSProVendor\WPDesk\Forms\FieldProvider $fields_provider, array $data)
    {
     ...
     * @return array
     */
    public function load_fields(\FSProVendor\WPDesk\Forms\FieldProvider $fields_provider)
    {
        $data = [];
        foreach ($fields_provider->get_fields() as $field) {
            $field_key = $field->get_name();
