 ...
 */
final class WordpressPostMetaContainer implements \FSProVendor\WPDesk\Persistence\PersistentContainer
{
    ...
    public function get($key)
    {
        ...
        if (\count($meta) === 0) {
            throw new \FSProVendor\WPDesk\Persistence\ElementNotExistsException(\sprintf('Element %s not exists!', $key));
        }
        return $meta[0];
    }
    /**
