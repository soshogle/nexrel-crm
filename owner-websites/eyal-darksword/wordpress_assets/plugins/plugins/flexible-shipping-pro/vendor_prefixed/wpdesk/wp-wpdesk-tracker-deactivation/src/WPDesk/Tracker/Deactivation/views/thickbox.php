...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'flexible-shipping-pro'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			...
			<div class="panel active" data-panel-id="reasons">
				<h4><strong><?php 
\_e('If you have a moment, please let us know why you are deactivating the plugin (anonymous feedback):', 'flexible-shipping-pro');
?></strong></h4>
...
?></span>
					...
					<li class="reason has-input">
						<label>
							...
							<span><?php 
\_e('I have found a better plugin', 'flexible-shipping-pro');
?></span>
						</label>
...
\_e('Please let us know how we can improve our plugin', 'flexible-shipping-pro');
?>">
						</div>
					</li>
				</ul>
