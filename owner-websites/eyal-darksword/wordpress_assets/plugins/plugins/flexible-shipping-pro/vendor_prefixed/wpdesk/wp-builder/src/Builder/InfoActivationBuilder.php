 ...
 */
class InfoActivationBuilder extends \FSProVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \FSProVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
