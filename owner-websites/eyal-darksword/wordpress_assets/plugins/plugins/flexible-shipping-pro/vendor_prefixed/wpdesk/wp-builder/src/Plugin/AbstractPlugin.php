...
abstract class AbstractPlugin extends \FSProVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin
{
    ...
    public function links_filter($links)
    {
        ...
        $plugin_links = ['<a target="_blank" href="' . $support_link . '">' . \esc_html__('Support', $this->get_text_domain()) . '</a>'];
        $links = \array_merge($plugin_links, $links);
        if ($this->docs_url) {
            $plugin_links = ['<a target="_blank" href="' . $this->docs_url . '">' . \esc_html__('Docs', $this->get_text_domain()) . '</a>'];
            $links = \array_merge($plugin_links, $links);
        }
        if ($this->settings_url) {
            $plugin_links = ['<a href="' . $this->settings_url . '">' . \esc_html__('Settings', $this->get_text_domain()) . '</a>'];
            $links = \array_merge($plugin_links, $links);
        }
        return $links;
    }
