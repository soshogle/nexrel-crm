...
class AjaxDeactivationDataHandler implements Hookable {
	...
	public function hooks() {
		add_action(
			'wp_ajax_'. self::AJAX_ACTION . $this->plugin_data->getPluginSlug(),
	...
	private function preparePayload( array $request ) {
		$payload = array(
			'click_action' => 'plugin_deactivation',
			'plugin'       => $this->plugin_data->getPluginFile(),
			'plugin_name'  => $this->plugin_data->getPluginTitle(),
