...
if ( ! class_exists( 'WC_Shipment_Tracking' ) ) :
	define( 'WC_SHIPMENT_TRACKING_VERSION', '2.6.2' ); // WRCS: DEFINED_VERSION.
 ...
 */
function wc_st_delete_tracking_number( $order_id, $tracking_number, $provider = '' ) {
	$st = WC_Shipment_Tracking_Actions::get_instance();
...
function wc_st_get_provider_alias( $provider ) {
	 ...
	 *
	 * @param array $provider_alias List of provider alias.
	 *
	 * @since 2.4.0
	 */
