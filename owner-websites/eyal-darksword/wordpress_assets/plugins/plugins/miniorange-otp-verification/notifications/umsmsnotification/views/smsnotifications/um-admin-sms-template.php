...
echo '				<div>
						...
						<div class="w-full flex">
								...
								<div class="flex-1 flex flex-wrap">
									<input type="text" name="' . esc_attr( $recipient_tag ) . '" id="' . esc_attr( $recipient_tag ) . '" value="' . esc_attr( $recipient_value ) . '"  class="w-full mo-input" placeholder="' . esc_html( __( 'Enter semi-colon (;) to separate multiple phone numbers.', 'miniorange-otp-verification' ) ) . '"/>
								 </div>
							</div>
							<div class="w-full flex">
								<div class="flex-1">
							...
							<div class="w-full flex">
								<div class="flex-1">
									...
									<p class="mo-caption mt-mo-2">' . esc_html( isset( $sms_settings->page_description ) ? $sms_settings->page_description : '' ) . '</p>
								</div>
								<div class="flex-1">
