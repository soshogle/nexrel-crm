...
// Access control check - only administrators can view customer SMS templates.
	...
	<div class="mt-mo-3 flex flex-col gap-mo-6">
		...
		<div class="w-full flex">
			<div class="flex-1">
				...
				<span class="py-mo-4 text-mo-lg text-left" style="display:block;">
					<b><?php echo esc_html( MoMessages::showMessage( MoMessages::DLT_TEMPLATE_TITLE ) ); ?></b>
					<span class="tooltip">
			...
			<?php if ( MoUtility::mo_is_whatsapp_notif_enabled() ) : ?>
				...
				<div class="flex flex-col gap-mo-4 flex-1">
					...
					<textarea id="<?php echo esc_attr( $variable_tag ); ?>" 
							...
							placeholder="<?php echo esc_attr( __( 'Enter sequence wise semicolon seperated tags used in message template. For eg. {Username}; {order-number}; {site-name}; {order-date};', 'miniorange-otp-verification' ) ); ?>"><?php echo esc_textarea( $sms_tags ); ?></textarea>
				</div>
			<?php else : ?>
				...
				<div class="flex-1">
					<textarea id="<?php echo esc_attr( $textarea_tag ); ?>" 
							...
							placeholder="<?php echo esc_attr( $default_sms_body ); ?>"><?php echo esc_textarea( $sms_body ); ?></textarea>
			...
			<div class="w-full flex">
				<div class="flex-1">
					...
					<p class="mo-caption mt-mo-2 pl-mo-6">
						<?php echo esc_html( __( 'Available in the ', 'miniorange-otp-verification' ) ) . '<i><u><a href="' . esc_url( admin_url() ) . 'admin.php?page=mootppricing" target="_blank" rel="noopener noreferrer">' . esc_html( __( 'WooCommerce plan', 'miniorange-otp-verification' ) ) . '</a></u></i>'; ?>
					</p>
				</div>
