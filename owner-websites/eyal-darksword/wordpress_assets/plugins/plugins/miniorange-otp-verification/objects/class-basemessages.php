...
if ( ! class_exists( 'BaseMessages' ) ) {
	...
	class BaseMessages {
		...
		const PREMIUM_FORM_MESSAGE    = 'PREMIUM_FORM_MESSAGE';
		...
		const WPCOMMENT_CHOOSE        = 'WPCOMMENT_CHOOSE';
		const WPCOMMENT_PHONE_ENTER   = 'WPCOMMENT_PHONE_ENTER';
		const WPCOMMENT_VERIFY_ENTER  = 'WPCOMMENT_VERIFY_ENTER';
		...
		const ORDER_REFUNDED_NOTIF_BODY        = 'ORDER_REFUNDED_NOTIF_BODY';
		...
		const NONCE_FAILED                         = 'NONCE_FAILED';
