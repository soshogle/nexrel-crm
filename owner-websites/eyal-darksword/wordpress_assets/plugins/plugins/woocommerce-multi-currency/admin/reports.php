	...
	public function admin_enqueue_scripts() {
		...
		if ( 'woocommerce_page_wc-reports' === $screen_id ) {
			...
			if ( ( $tab === 'orders' && $report !== 'coupon_usage' ) || ( $tab === 'customers' && $report === 'customers' ) ) {
				wp_enqueue_style( 'woocommerce-multi-currency-admin-reports', WOOMULTI_CURRENCY_CSS . 'reports' . $src_min . '.css', '', WOOMULTI_CURRENCY_VERSION );
				wp_enqueue_script( 'woocommerce-multi-currency-admin-reports', WOOMULTI_CURRENCY_JS . 'reports' . $src_min . '.js', array( 'jquery' ), WOOMULTI_CURRENCY_VERSION, false );
