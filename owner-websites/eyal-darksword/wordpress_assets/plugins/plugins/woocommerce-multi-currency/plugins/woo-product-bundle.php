...
class WOOMULTI_CURRENCY_Plugin_Woo_Product_Bundle {
	...
	public function __construct() {
		...
		if ( $this->settings->get_enable() && ( is_plugin_active( 'woo-product-bundle-premium/wpc-product-bundles.php' ) || is_plugin_active( 'woo-product-bundle/wpc-product-bundles.php' ) ) ) {
