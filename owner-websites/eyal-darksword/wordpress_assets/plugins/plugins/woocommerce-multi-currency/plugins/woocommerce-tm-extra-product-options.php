...
class WOOMULTI_CURRENCY_Plugin_WooCommerce_TM_Extra_Product_Options {
	...
	public function __construct() {
		...
		if ( $this->settings->get_enable() ) {
			if ( defined( 'THEMECOMPLETE_EPO_VERSION' ) && version_compare( THEMECOMPLETE_EPO_VERSION, '7.0', '>=' ) ) {
...
//			if ( is_plugin_active( 'woocommerce-tm-extra-product-options/tm-woo-extra-product-options.php' ) && defined('THEMECOMPLETE_EPO_PLUGIN_FILE' ) ) {
//				$epo_version = get_file_data(
