				...
				<div class="wmc-currency <?php echo esc_attr( $selected ) ?>"
					...
					<a rel='nofollow' class="wmc-currency-redirect"
					   data-currency="<?php echo esc_attr( $k ) ?>" href="<?php echo esc_attr( $link ) ?>">
						<span class="wmc-currency-content-dtname"><span class="wmc-currency-content-dtname-name"><?php echo wp_kses_post( $display ); ?></span></span>
						<span class="wmc-currency-content-dtdetail">
                            <?php
                            $country = esc_html( strtolower( $settings->get_country_data( $k )['code'] ) );
                            echo '<span class="wmc-currency-content-dtdetail-info">' .
