...
class I13_Woo_Google_Recpatcha {
	...
	public function i13_jetpack_contact_form_is_spam( $flag, $akismet_values ) {
		...
		if ( 'yes' == $use_v2_along_v3 && isset($_POST) && isset($_POST['g-recaptcha-response'])) {
			...
			if ( 'yes' == $is_enabled && ! in_array( $pid, $exlude_froms ) ) {
			   ...
			   return new WP_Error( 'Captcha Invalid', '<strong>' . __( 'ERROR:', 'recaptcha-for-woocommerce' ) . '</strong> ' . __( 'Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce' ) );
								...
								if ( 'yes' == $use_v2_along_v3 ) {
									...
									return new WP_Error( 'Captcha Invalid', '<strong>' . __( 'ERROR:', 'recaptcha-for-woocommerce' ) . '</strong> ' . $recapcha_error_msg_captcha_no_response );
										...
										$data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_action_v3));
			 ...
			 $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_action_v3 )) {
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
				...
				?><!-- do_not_format_javascript --><script type="text/javascript" id="<?php echo esc_html( $rand_char ); ?>">
									...
									/in/.test(document.readyState) ? setTimeout('intval_jetpack_froms_ready(' + f + ')', 9) : f()
																...
																function callback_recpacha<?php echo esc_html($rand_char); ?>(){
																						...
																						if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptcha_jetpack_form<?php echo esc_html($rand_char); ?> === null) {
																							   ...
																							   <?php endif; ?>
																																																					   ...
																																																					   try{
																																																													   myCaptcha_jetpack_form<?php echo esc_html($rand_char); ?>=<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-jetpack-method-<?php echo esc_html($rand_char); ?>', {
					  ...
					  var waitForEl = function(selector, callback) {
							...
							if (jQuery("#"+selector).length) {
															...
															if ((typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) === 'undefined' || typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) === 'undefined') && myCaptcha_jetpack_form<?php echo esc_html( $rand_char ); ?> === null) {
					...
					<div id="g-recaptcha-jetpack-method" name="g-recaptcha-jetpack-method"  data-callback="verifyCallback_jetpackform<?php echo esc_html( $rand_char ); ?>" data-sitekey="<?php echo esc_html( $site_key ); ?>" data-theme="<?php echo esc_html( $theme ); ?>" data-size="<?php echo esc_html( $size ); ?>"></div></div>`).ready(function () {
							...
							<?php endif; ?>
								...
								waitForEl('g-recaptcha-jetpack-method-<?php echo esc_html( $rand_char ); ?>', function() {
																				...
																				if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptcha_jetpack_form<?php echo esc_html( $rand_char ); ?> === null) {
			...
			if ( trim( $i13_recapcha_woo_jetpack_exclude ) != '' ) {
				...
				$exlude_froms = explode( ',', $i13_recapcha_woo_jetpack_exclude );
						...
						$i13_recapcha_msg_token_generation = get_option( 'i13_recapcha_msg_token_generation' );
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
											...
											intval_jetpack_froms_v3_ready(function () {
															...
															jQuery("[name=contact-form-hash][value=<?php echo esc_html( $contactFormHash ); ?>]").after(`<input type="hidden" autocomplete="off" name="woo-jetpack-nonce" value="<?php echo esc_html( wp_create_nonce( 'i13-jetpack-nonce' ) ); ?>" /><input type="hidden" value="" name="i13_recaptcha_jetpack_method_token" id="i13_recaptcha_jetpack_method_token" />`);
																	...
																	if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																		...
																		setInterval(function() {
																				 ...
																				 if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																						<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_action_v3 ); ?>' }).then(function (token) {
																...
																function i13RenderJetpackCaptchaV3(){
																			 ...
																			 <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.ready(function () {
...
document.addEventListener('DOMContentLoaded', function() {
				...
				if ( 'yes' == $is_enabled && ! is_user_logged_in() ) {
					...
					?>
						...
						<div id='refresh_captcha' style="width:100%;padding-top:5px"> 
							<a href="javascript:(function(){<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(myCaptcha); window.recap_val=null})();" style="clear:both"><?php echo esc_html( $refresh_lable ); ?></a>
						</div>    
					...
					<!-- do_not_format_javascript --><script type="text/javascript">
						...
						function reRenderCaptcha() {
							...
							try {
								myCaptcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-checkout-i13', {
									'sitekey': '<?php echo esc_html( $site_key ); ?>',
						...
						intval_payment_rq_guest_ready(function () {
								...
								if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptcha === null) {
					...
					?>
						...
						<div id='refresh_captcha' style="width:100%;padding-top:5px"> <a href="javascript:(function(){<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(myCaptcha); window.recap_val=null})();"><?php echo esc_html( $refresh_lable ); ?></a></div>
				...
				if ( ( 'yes' == $is_enabled && ! is_user_logged_in() ) || ( 'yes' == $is_enabled_logincheckout && is_user_logged_in() ) ) {
					...
					<!-- do_not_format_javascript --><script type="text/javascript">
						...
						intval_payment_rq_guest_v3_ready(function () {
														...
														if (typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																...
																i13RenderPayReqCaptchaV3();
																		...
																		jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=i13RenderPayReqCaptchaV3", function() {
													...
													jQuery(document).ajaxComplete(function () {
														 ...
														 setTimeout(function() { 
															 ...
															 if (jQuery(".woocommerce-error").is(":visible") || jQuery(".woocommerce_error").is(":visible")) {
																 ...
																 if (typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																 <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html($site_key); ?>', {action: '<?php echo esc_html($i13_recapcha_checkout_action_v3); ?>'}).then(function (token) {
				...
				if ( ! is_admin() && isset( $_POST['comment_post_ID'], $comment_data['comment_type'] ) && 'product' !== get_post_type( absint( $_POST['comment_post_ID'] ) ) && 'review' !== $comment_data['comment_type'] ) { // WPCS: input var ok, CSRF ok.
					...
					set_transient( 'i13_' . COOKIEHASH_I13 . '_wp_comments', '1', $i13_recapcha_v2_timeout );
							...
							exit;
								...
								$data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_woo_comment_method_action_v3));
							...
							if ( is_array( $verifyResponse ) && ! is_wp_error( $verifyResponse ) && isset( $verifyResponse['body'] ) ) {
								...
								if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
									...
									if ( ( $responseData->riskAnalysis->score < $i13_recapcha_woo_comment_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_woo_comment_method_action_v3 )) {
				...
				if ( ! is_admin() && isset( $_POST['comment_post_ID'], $comment_data['comment_type'] ) && 'product' === get_post_type( absint( $_POST['comment_post_ID'] ) ) && 'review' === $comment_data['comment_type'] && wc_reviews_enabled() ) { // WPCS: input var ok, CSRF ok.
				   ...
				   exit;
					 ...
					 exit;
								  ...
								  $data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_woo_review_method_action_v3));
						   ...
						   $responseData = json_decode( $verifyResponse['body'] );
								...
								if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
									...
									if ( ( $responseData->riskAnalysis->score < $i13_recapcha_woo_review_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_woo_review_method_action_v3 )) {
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
						...
						intval_comment_form_ready(function () {
							...
							<?php endif; ?>
														  ...
														  if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptchacomment === null) {
							...
							if (typeof woo_comment_captcha_verified === "function") {
								...
								woo_comment_captcha_verified(response);
									   ...
									   function i13renderCommentCaptchaV2(){
											...
											try{
													myCaptchacomment = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-comment-i13', {
													'sitekey': '<?php echo esc_html( $site_key ); ?>',
						...
						intval_comment_form_v3_ready(function () {
														...
														if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																	   ...
																	   i13RenderCommentCaptchaV3();
																			   ...
																			   jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=i13RenderCommentCaptchaV3", function() {
								...
								setInterval(function () {
																	...
																	if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																					...
																					<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', {action: '<?php echo esc_html( $i13_recapcha_comment_action_v3 ); ?>'}).then(function (token) {
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
			...
			if ( 'yes' == $is_enabled ) {
				...
				?>
					...
					<div  id="g-recaptcha-review-i13" name="g-recaptcha-review-i13" class="g-recaptcha" data-callback="verifyCallback_woo_review" data-sitekey="<?php echo esc_html( $site_key ); ?>" data-theme="<?php echo esc_html( $theme ); ?>" data-size="<?php echo esc_html( $size ); ?>"></div>
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
					...
					intval_review_form_ready(function () {
							...
							<?php endif; ?>
															...
															if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptchareview === null) {
							...
							if (typeof woo_review_captcha_verified === "function") {
								...
								woo_review_captcha_verified(response);
										 ...
										 function i13renderReviewCaptchaV2(){
											...
											try{
													myCaptchareview = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-review-i13', {
													'sitekey': '<?php echo esc_html( $site_key ); ?>',
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
					...
					intval_review_form_v3_ready(function () {
												...
												setInterval(function () {
														...
														if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', {action: '<?php echo esc_html( $i13_recapcha_review_action_v3 ); ?>'}).then(function (token) {
	...
	public function i13_google_recaptcha_defer_parsing_of_js( $url ) {
		...
		if ( strpos( $url, 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha' ) !== false ) {
...
$validation_errors->add( 'g-recaptcha_error', $recapcha_error_msg_captcha_no_response );
									   ...
									   $data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_signup_action_v3));
			  ...
			  $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $i13_recapcha_signup_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_signup_action_v3 )) {
			...
			if ( 'yes' == $is_enabled && isset( $_POST['form'] ) && 'sensei-login' == $_POST['form'] ) {
			   ...
			   set_transient( 'i13_' . COOKIEHASH_I13 . '_wp_login', '1', $i13_recapcha_v2_timeout );
				...
				wp_die( '<strong>' . esc_html( __( 'ERROR:', 'recaptcha-for-woocommerce' ) ) . '</strong> ' . esc_html( $recapcha_error_msg_captcha_no_response ) );
									   ...
									   $data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_wp_login_action_v3));
			  ...
			  $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $i13_recapcha_wp_login_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_wp_login_action_v3 )) {
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
			...
			if ( 'yes' == $is_enabled && isset( $_POST['sensei_reg_email'] ) && isset( $_POST['sensei_reg_password'] ) ) {
				...
				wp_die( '<strong>' . esc_html( __( 'ERROR:', 'recaptcha-for-woocommerce' ) ) . '</strong> ' . esc_html( $recapcha_error_msg_captcha_no_response ) );
									   ...
									   $data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_wp_register_method_action_v3));
			  ...
			  $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $i13_recapcha_wp_register_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_wp_register_method_action_v3 )) {
				...
				if ( isset( $_POST['i13_recaptcha_token'] ) && ! empty( $_POST['i13_recaptcha_token'] ) ) {
					...
					if (!I13_IS_ENTERPRISE_CAPTCHA) { 
					 ...
					 $validation_errors->add( 'g-recaptcha_error', '<strong>' . __( 'ERROR:', 'recaptcha-for-woocommerce' ) . '</strong> ' . __( 'Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce' ) );
								   ...
								   $validation_errors->add( 'g-recaptcha_error', '<strong>' . __( 'ERROR:', 'recaptcha-for-woocommerce' ) . '</strong> ' . $recapcha_error_msg_captcha_no_response );
									...
									$data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_wp_lost_password_method_action_v3));
				 ...
				 $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $i13_recapcha_wp_lost_password_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_wp_lost_password_method_action_v3 )) {
	...
	public function i13_woocomm_validate_checkout_captcha( $fields, $validation_errors ) {
		...
		if ( ! $is_ppc_posted ) {
			...
			if ( 'yes' == $use_v2_along_v3 && isset($posted_data_i13) && isset($posted_data_i13['g-recaptcha-response'])) {
				...
				'body' => array(
					...
					'response' => $i13_checkout_token,
							...
							if ( is_array( $verifyResponse ) && ! is_wp_error( $verifyResponse ) && isset( $verifyResponse['body'] ) ) {
								...
								if ( ! $responseData->success ) {
									...
									if ( '' == trim( $recapcha_error_msg_captcha_invalid ) ) {
										...
										$validation_errors->add( 'g-recaptcha_error', '<span data-reload="' . $reload . '" id="g-recaptcha_error_v3"></span>' . __( 'Google reCAPTCHA verification failed, please try again later.', 'recaptcha-for-woocommerce' ) );
									} else {
										$validation_errors->add( 'g-recaptcha_error', '<span data-reload="' . $reload . '" id="g-recaptcha_error_v3"></span>' . $recapcha_error_msg_captcha_invalid );
									}
								} else {
								...
								if ( '' == trim( $recapcha_error_msg_captcha_no_response ) ) {
									...
									$validation_errors->add( 'g-recaptcha_error', '<span data-reload="' . $reload . '"  id="g-recaptcha_error_v3"></span>' . __( 'Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce' ) );
								} else {

									$validation_errors->add( 'g-recaptcha_error', '<span data-reload="' . $reload . '"  id="g-recaptcha_error_v3"></span>' . $recapcha_error_msg_captcha_no_response );
								}
							}
								   ...
								   $data=array('event'=>array('token'=>$i13_checkout_token,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_checkout_action_v3));
						...
						if ( '' == trim( $recapcha_error_msg_captcha_blank ) ) {
											...
											$validation_errors->add( 'g-recaptcha_error', '<span data-reload="' . $reload . '"  id="g-recaptcha_error_v3"></span>' . __( 'Google reCAPTCHA token is missing.', 'recaptcha-for-woocommerce' ) );
						} else {

												$validation_errors->add( 'g-recaptcha_error', '<span  data-reload="' . $reload . '"  id="g-recaptcha_error_v3"></span>' . $recapcha_error_msg_captcha_blank );
						}
					}
				} else {

					$validation_errors->add( 'g-recaptcha_error', '<span id="g-recaptcha_error_v3"></span>' . __('Could not verify request.', 'recaptcha-for-woocommerce' ) );
				}
			}
		}
			...
			set_transient( 'i13_' . COOKIEHASH_I13 . '_woo_lostpass', '1', $i13_recapcha_v2_timeout );
					   ...
					   $validation_errors->add( 'g-recaptcha_error', __( 'Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce' ) );
							 ...
							 $validation_errors->add( 'g-recaptcha_error', $recapcha_error_msg_captcha_no_response );
									   ...
									   $data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_lostpassword_action_v3));
			  ...
			  $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $i13_recapcha_lostpassword_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_lostpassword_action_v3 )) {
			...
			if ( 'yes' == $is_enabled && isset( $_POST['username'] ) && wp_verify_nonce( $nonce_value, 'woocommerce-login' ) ) {
						...
						if ( is_array( $verifyResponse ) && ! is_wp_error( $verifyResponse ) && isset( $verifyResponse['body'] ) ) {
							...
							if ( '' == trim( $recapcha_error_msg_captcha_no_response ) ) {
									...
									$validation_errors->add( 'g-recaptcha_error', $recapcha_error_msg_captcha_no_response );
										...
										$data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_login_action_v3));
			 ...
			 $responseData = json_decode( $verifyResponse['body'] );
							...
							if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
								...
								if ( ( $responseData->riskAnalysis->score < $i13_recapcha_login_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_login_action_v3 )) {
	...
	public function i13_checkout_block_captcha($order) {
			

	 $rawData=file_get_contents('php://input');
	 $arrdata=json_decode($rawData, true);
			
	 //file_put_contents(dirname(__FILE__).'/abc.txt',print_r($this->is_payment_request_btn($arrdata),true));
	 $reCapcha_version = get_option('i13_recapcha_version');
		if ('' == $reCapcha_version) {
					$reCapcha_version = 'v2';
		}
		if ('v2' == strtolower($reCapcha_version)) {
			...
			if (! wp_verify_nonce( $nonce_value, 'i13-woocommerce-process_checkout-block' ) ) {
				 ...
				 throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
																		 'recaptcha-error',
																		 __('Could not verify request.', 'recaptcha-for-woocommerce'),
																		 400
																 );
			...
			if (( ( 'yes'==$is_enabled && !is_user_logged_in() ) || ( 'yes'==$i13_recapcha_enable_on_logincheckout  && is_user_logged_in() ) ) &&  isset($arrdata['payment_method']) && !$this->i13_is_payment_request_btn($arrdata)) {
				...
				if ( isset($arrdata['extensions']) && isset($arrdata['extensions']['i13-recaptcha-checkout-block']) && isset($arrdata['extensions']['i13-recaptcha-checkout-block']['g-recaptcha-response-v2']) ) {
					...
					// If reCAPTCHA response is valid 
					  ...
					  throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
									 'recaptcha-error',
									 __('Invalid recaptcha.', 'recaptcha-for-woocommerce'),
									 403
							 );
							   ...
							   throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
								'recaptcha-error',
								$recapcha_error_msg_captcha_invalid,
								403
								);
						...
						if ('' == trim($recapcha_error_msg_captcha_no_response)) {
										  ...
										  throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
																'recaptcha-error',
																__('Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce'),
																403
														);
														 ...
														 throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
																			'recaptcha-error',
																			$recapcha_error_msg_captcha_no_response,
																			403
																	);
					...
					if ('' == trim($recapcha_error_msg_captcha_blank)) {
											   ...
											   throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
																			'recaptcha-error',
																			__('Recaptcha is a required field.', 'recaptcha-for-woocommerce'),
																			403
																	);
													 ...
													 throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
																				'recaptcha-error',
																				$recapcha_error_msg_captcha_blank,
																				403
																		);
			...
			if (! wp_verify_nonce( $nonce_value, 'i13-woocommerce-process_checkout-block' ) ) {
				...
				throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
														   'recaptcha-error',
														   __('Could not verify request.' . $nonce_value, 'recaptcha-for-woocommerce'),
														   403
												   );
			...
			if (( ( 'yes'==$is_enabled && !is_user_logged_in() ) || ( 'yes'==$i13_recapcha_enable_on_logincheckout  && is_user_logged_in() ) ) &&  isset($arrdata['payment_method']) && !$this->i13_is_payment_request_btn($arrdata)) {
				...
				if ( isset($arrdata['extensions']) && isset($arrdata['extensions']['i13-recaptcha-checkout-block']) && isset($arrdata['extensions']['i13-recaptcha-checkout-block']['i13_checkout_token_']) ) {
					...
					if (is_array($verifyResponse) && !is_wp_error($verifyResponse) && isset($verifyResponse['body'])) {
						...
						if (!$responseData->success) {
							...
							if ('' == trim($recapcha_error_msg_captcha_invalid)) {
																...
																throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
																  'recaptcha-error',
																  __('Google reCAPTCHA verification failed, please try again later.', 'recaptcha-for-woocommerce'),
																  403
														  );
					...
					if ('' == trim($recapcha_error_msg_captcha_blank)) {
											 ...
											 throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
														  'recaptcha-error',
														  __('Google reCAPTCHA token is missing.', 'recaptcha-for-woocommerce'),
														  403
													  );
				 ...
				 set_transient( 'i13_' . COOKIEHASH_I13 . '_woo_add_payment_method', '1', $i13_recapcha_v2_timeout );
					   ...
					   return false;
							 ...
							 return false;
									   ...
									   $data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_add_payment_method_action_v3));
									...
									if ( is_array( $verifyResponse ) && ! is_wp_error( $verifyResponse ) && isset( $verifyResponse['body'] ) ) {
									  ...
									  $responseData = json_decode( $verifyResponse['body'] );
										...
										if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
											...
											if ( ( $responseData->riskAnalysis->score < $i13_recapcha_add_payment_method_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_add_payment_method_action_v3 )) {
				  ...
				  intval_payment_method_new_ready(function () {
						...
						<?php if ( 'yes' == trim( $disable_submit_btn ) ) : ?>
								jQuery('#add_payment_method').submit(function () {
									if (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.getResponse() == "") {
				...
				<?php endif; ?>
									...
									if (typeof add_payment_method_recaptcha_verified === "function") {
										...
										add_payment_method_recaptcha_verified(response);
														...
														if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptcha_payment_method === null) {    
										...
										function i13_pm_renderReCaptchaV2(){
													 ...
													 <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.ready(function () {
														...
														try{
																myCaptcha_payment_method = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-payment-method', {
																'sitekey': '<?php echo esc_html( $site_key ); ?>',
				  ...
				  intval_payment_method_new_v3_ready(function () {
											...
											if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
													...
													setInterval(function () {
																	...
																	if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																							<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', {action: '<?php echo esc_html( $i13_recapcha_add_payment_method_action_v3 ); ?>'}).then(function (token) {
			...
			if ( 'yes' == $is_enabled && is_user_logged_in() && function_exists( 'is_wc_endpoint_url' ) && is_wc_endpoint_url( get_option( 'woocommerce_myaccount_add_payment_method_endpoint', 'add-payment-method' ) ) ) {
				...
				<?php endif; ?>
							...
							function callback_recpacha(){
									...
									if (typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptcha_payment_method === null) {
	...
	public function i13_woo_get_recaptcha_js_url() {
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
			...
			$url = 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha';
		} else {

			$url = 'https://www.' . ( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha';
		}
	...
	public function i13_woo_recaptcha_load_styles_and_js() {
		...
		if ('v3'== strtolower($reCapcha_version)) {
			...
			// wp_register_style('i13-woo-styles', plugins_url('/public/css/styles.css', __FILE__), array(), '1.0');
				if ( '' != $i13_recapcha_v2_lang ) {
					...
					wp_register_script( 'i13-woo-captcha', 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha&hl=' . $i13_recapcha_v2_lang, array(), '1.0' );
					wp_register_script( 'i13-woo-captcha-explicit', 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha&render=explicit&hl=' . $i13_recapcha_v2_lang, array(), '2.0' );
				} else {
					wp_register_script( 'i13-woo-captcha', 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha', array(), '1.0' );
					wp_register_script( 'i13-woo-captcha-explicit', 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha&render=explicit', array(), '2.0' );
				}
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
			...
			$site_key = get_option( 'wc_settings_tab_recapcha_site_key_v3' );
			wp_register_script( 'i13-woo-captcha-v3', 'https://www.' . esc_html( sanitize_text_field( $this->get_recaptcha_domain() ) ) . '/recaptcha/' . I13_USE_API . '?from=i13_recaptcha&render=' . esc_html( $site_key ), array( 'jquery' ), '1.0' );
			$is_enabled = get_option( 'i13_recapcha_enable_on_guestcheckout' );
			$is_enabled_on_payment_page = get_option( 'i13_recapcha_enable_on_addpaymentmethod' );
			$is_enabled_logincheckout = get_option( 'i13_recapcha_enable_on_logincheckout' );
			$i13_recapcha_enable_on_payfororder = get_option( 'i13_recapcha_enable_on_payfororder' );
				...
				<!-- do_not_format_javascript --><script type="text/javascript" id="woo_recaptcha_register_v2">
						   ...
						   intval_woo_reg_method_ready(function () { 
							...
							try{
								...
								if ((typeof (window.grecaptcha) == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' ||  typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) == 'undefined') && el_i13_register_captcha == null){
										...
										el_i13_register_captcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('<?php echo esc_html( $unique_id ); ?>', {
												'sitekey': '<?php echo esc_html( $site_key ); ?>',
								...
								try{
										...
										var myNodeList = document.querySelectorAll('.g-recaptcha-register-i13');
											...
											if (el.childElementCount == 0){
													...
													try{
															el_i13_register_captcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render(el, {
															'sitekey': '<?php echo esc_html( $site_key ); ?>',
																	'callback' : 'verifyCallback_woo_signup'
															});
													} catch (error){}
												...
												<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(el_i13_register_captcha);
											}
										  });
								  } catch (error){}
			...
			if ( 'yes' == $is_enabled ) {
				...
				function intval_woo_reg_method_v3_ready(f) {
				  ...
				  intval_woo_reg_method_v3_ready(function () { 
							...
							if ((typeof (window.grecaptcha) == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' ||  typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) == 'undefined') && el_i13_register_captcha == null){
								...
								jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=reRender_Woo_Signup_Captcha_v3", function() {
									...
									<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.ready(function () {
									 ...
									 el_i13_register_captcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_signup_action_v3 ); ?>' }).then(function (token) {
	...
	public function     i13woo_extra_checkout_fields() {
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
			...
			if ( 'yes' == $is_enabled && ! is_user_logged_in() ) {
				...
				<div id="g-recaptcha-checkout-i13" name="g-recaptcha" class="g-recaptcha-" data-callback="verifyCallback_add_guestcheckout"  data-sitekey="<?php echo esc_html( $site_key ); ?>" data-theme="<?php echo esc_html( $theme ); ?>" data-size="<?php echo esc_html( $size ); ?>"></div>
				<div id='refresh_captcha' style="width:100%;padding-top:5px"> 
					<a href="javascript:<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(myCaptcha);" style="clear:both"><?php echo esc_html( $refresh_lable ); ?></a>
				</div>    
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
				  ...
				  intval_checkout_ready(function () { 
					...
					jQuery(document).on('updated_checkout', function () {
													...
													if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && window.myCaptcha === null) {
						...
						<?php if ( 'yes' == $i13_recapcha_guest_recpacha_refersh_on_error ) : ?>
							...
							<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(window.myCaptcha);
							<?php if ( 'yes' == trim( $disable_submit_btn ) ) : ?>
								jQuery("#place_order").attr("disabled", true);
								<?php if ( '' == $recapcha_error_msg_captcha_blank ) : ?>
									jQuery("#place_order").attr("title", "<?php echo esc_html( __( 'Recaptcha is a required field.', 'recaptcha-for-woocommerce' ) ); ?>");
				...
				?>
				<div id="g-recaptcha-checkout-i13" name="g-recaptcha" class="g-recaptcha-" data-callback="verifyCallback_add_logincheckout"   data-sitekey="<?php echo esc_html( $site_key ); ?>" data-theme="<?php echo esc_html( $theme ); ?>" data-size="<?php echo esc_html( $size ); ?>"></div>
				<div id='refresh_captcha' style="width:100%;padding-top:5px"> <a href="javascript:<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(myCaptcha);"><?php echo esc_html( $refresh_lable ); ?></a></div>
				  ...
				  intval_login_checkout_ready(function () { 
						...
						<?php if ( 'yes' == $i13_recapcha_login_recpacha_refersh_on_error ) : ?>
							jQuery('body').on('checkout_error', function(){
								...
								myCaptcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(myCaptcha);
								<?php if ( 'yes' == trim( $disable_submit_btn ) ) : ?>
										jQuery("#place_order").attr("disabled", true);
									<?php if ( '' == $recapcha_error_msg_captcha_blank ) : ?>
											jQuery("#place_order").attr("title", "<?php echo esc_html( __( 'Recaptcha is a required field.', 'recaptcha-for-woocommerce' ) ); ?>");
				  ...
				  intval_checkout_v3_ready(function () { 
												...
												if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
														...
														i13RenderReCaptchaV3();
														   ...
														   jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=i13RenderReCaptchaV3", function() {
											...
											el.value = token;
																														...
																														window.fetch = async function(input, init) {
																															...
																															try {
																																...
																																if(!recaptchaResponse || recaptchaResponse.val()==null || recaptchaResponse.val()==''){
																																	...
																																	recaptchaResponse = jQuery('.fallback_i13_checkout_token');

																																}
																																tokenVal='';
																																Array.from(recaptchaResponse).forEach(function(el) {
																																tokenVal = jQuery(el).val();
																																});
																																if(!tokenVal || tokenVal==null || tokenVal==''){
																																	setTimeout(() => alert('<?php echo esc_html($recapcha_error_msg_captcha_blank); ?>'), 2000);
																																	return Promise.reject('<?php echo esc_html($recapcha_error_msg_captcha_blank); ?>');
																																}
																																...
																																if (options.body && typeof options.body === "string") {
																																	const bodyObj = JSON.parse(options.body);
																																	bodyObj.recaptcha_token_v3 = tokenVal;
																																	bodyObj.recaptcha_i13_nonce = '<?php echo esc_html(wp_create_nonce('i13-woocommerce-process_checkout-block')); ?>';
																																	bodyObj.cookiehash_i13 = '<?php echo esc_html(COOKIEHASH_I13); ?>';
																																	bodyObj.js_context = 'inline';
																																	bodyObj.recap_v = 'v3';
															...
															jQuery(document).ajaxSend(function(event, jqXHR, settings) {
																...
																if(settings.url.indexOf('wc-ajax=checkout') !== -1 || settings.url.indexOf('wc-ajax=wcstripe_create_order') !== -1 ||  (settings.url.indexOf('wc-ajax=wc_stripe_frontend_request') !== -1 && settings.url.indexOf('path=/wc-stripe/v1/checkout') !== -1) || settings.url.indexOf('wc-ajax=wc_stripe_create_order') !== -1 || settings.url.indexOf('wc-ajax=wcpay_create_order') !== -1 || settings.url.indexOf('wc-ajax=wc_ajax_square_digital_wallet_process_checkout') !== -1){
																		...
																		var myNodeList = document.querySelectorAll('.i13_checkout_token');
																																				Array.from(myNodeList).forEach(function(el) {
																			   settings.data += '&i13_checkout_token='+el.value;
																																				});
																																	   }
																																		if(settings.data.indexOf('fallback_i13_checkout_token' + '=') === -1 ){
																		var myNodeList = document.querySelectorAll('.fallback_i13_checkout_token');
				...
				function intval_woo_login_ready(f) {
				  ...
				  intval_woo_login_ready(function () { 
								...
								try{
									...
									if ((typeof (window.grecaptcha) == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' ||  typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) == 'undefined') && el_i13_login_captcha == null){
									...
									el_i13_login_captcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('<?php echo esc_html( $unique_id ); ?>', {
									'sitekey': '<?php echo esc_html( $site_key ); ?>',
					   ...
					   function reRender_Woo_Login_Captcha(){
							...
							try{
									...
									if (el.childElementCount == 0){
											...
											try{
													el_i13_login_captcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render(el.id, {
													'sitekey': '<?php echo esc_html( $site_key ); ?>',
															'callback' : 'verifyCallback_woo_login'
													});
											} catch (error){}
										...
										<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.reset(el_i13_login_captcha);
									}
								 });
							} 
							catch (error){}
			...
			if ( 'yes' == $is_enabled ) {
				...
				function intval_woo_login_v3_ready(f) {
				  ...
				  intval_woo_login_v3_ready(function () { 
						 ...
						 if ((typeof (window.grecaptcha) == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' ||  typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) == 'undefined') && el_i13_login_captcha == null){
						...
						setInterval(function() {
															...
															if(typeof (window.grecaptcha) !== 'undefined' && typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> !== 'undefined' &&  typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined'){
																	<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_login_action_v3 ); ?>' }).then(function (token) {
			...
			<?php if ( ( 'v2' == strtolower( $reCapcha_version ) && ( 'yes' == $i13_recapcha_using_ajax_login_v2 || 'yes' == $i13_recapcha_using_ajax_registration_v2 ) ) || ( 'v3' == strtolower( $reCapcha_version ) && ( 'yes' == $i13_recapcha_using_ajax_login_v3 || 'yes' == $i13_recapcha_using_ajax_registration_v3 ) ) ) : ?>
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
					  ...
					  intval_woo_ajax_signup_ready(function () { 
							...
							<?php if ( 'v2' == strtolower( $reCapcha_version ) ) : ?>
								...
								<?php if ( 'yes' == $i13_recapcha_using_ajax_login_v2 ) : ?>
										...
										if (typeof (window.grecaptcha) == 'undefined' || typeof grecaptcha == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' || el_i13_login_captcha == null){
					...
					<?php endif; ?>
							...
							if (typeof xhr.responseText !== 'undefined' && xhr.responseText.indexOf('woo_recaptcha_register_v2') !== - 1 && document.getElementById('woo_recaptcha_register_v2')){
									...
									if (typeof grecaptcha == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' || el_i13_register_captcha == null){
				...
				<?php else : ?>
					...
					<?php if ( 'yes' == $i13_recapcha_using_ajax_registration_v3 ) : ?>
							...
							if (typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' || el_i13_register_captcha == null){
	...
	public function i13woo_extra_checkout_fields_pay_order() {
		...
		if ( 'v2' == strtolower( $reCapcha_version ) ) {
			...
			if ( 'yes' == $is_enabled ) {
				...
				?>
				<input type="hidden" value="" class="i13_checkout_token"  name="i13_checkout_token" id="i13_checkout_token"/>
								<input class="fallback_i13_checkout_token" type="hidden" value="" name="fallback_i13_checkout_token" id="fallback_i13_checkout_token"/>
				<!-- do_not_format_javascript --><script type="text/javascript">
			...
			if ( 'yes' == $is_enabled ) {
				...
				<?php endif; ?>
								 ...
								 function i13renderRe_FP_CaptchaV2(){
										...
										try{
												myCaptcha_fp = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-lostpassword-i13', {
												'sitekey': '<?php echo esc_html( $site_key ); ?>',
					  ...
					  intval_woo_forgotpass_v3_ready(function () { 
												...
												setInterval(function() {
																...
																if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																				...
																				<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_lostpassword_action_v3 ); ?>' }).then(function (token) {
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
					  ...
					  intval_wp_login_ready(function () { 
							...
							<?php endif; ?>
														...
														if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptchaWpLogin === null) {
															  ...
															  i13renderWpLoginCaptchaV2();
																  ...
																  jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&hl=<?php echo esc_html( $i13_recapcha_v2_lang ); ?>&onload=i13renderWpLoginCaptchaV2", function() {
							...
							if (typeof woo_wp_login_captcha_verified === "function") {
								 ...
								 woo_wp_login_captcha_verified(response);
												...
												function i13renderWpLoginCaptchaV2(){
													  ...
													  try{
															  myCaptchaWpLogin = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-review-i13', {
															  'sitekey': '<?php echo esc_html( $site_key ); ?>',
				  ...
				  intval_wp_login_v3_ready(function () { 
										  ...
										  if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
												...
												i13renderWpLoginCaptchaV3();
													...
													jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=i13renderWpLoginCaptchaV3", function() {
						...
						setInterval(function() {
																...
																if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																		<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_wp_login_action_v3 ); ?>' }).then(function (token) {
					...
					function intval_wp_lostpass_ready(f) {
					  ...
					  intval_wp_lostpass_ready(function () { 
							...
							<?php endif; ?>
														 ...
														 if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptchawp_los_pass === null) {
																...
																i13renderWpLostCaptchaV2();
																	...
																	jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&hl=<?php echo esc_html( $i13_recapcha_v2_lang ); ?>&onload=i13renderWpLostCaptchaV2", function() {
									...
									if (typeof woo_wp_lost_password_captcha_verified === "function") {
											 ...
											 woo_wp_lost_password_captcha_verified(response);
														...
														function i13renderWpLostCaptchaV2(){
															...
															try{
																	myCaptchawp_los_pass = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-wp-lostpassword-i13', {
																	'sitekey': '<?php echo esc_html( $site_key ); ?>',
			   ...
			   intval_wp_lostpass_v3_ready(function () { 
														...
														if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																...
																i13renderWpLostCaptchaV3();
																	...
																	jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=i13renderWpLostCaptchaV3", function() {
									...
									setInterval(function() {
																				...
																				if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') { 
																					<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_wp_lost_password_method_action_v3 ); ?>' }).then(function (token) {
						...
						<?php endif; ?>
												...
												if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && myCaptcha === null) {
													  ...
													  i13renderWpRegisterCaptchaV2();
														  ...
														  jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&hl=<?php echo esc_html( $i13_recapcha_v2_lang ); ?>&onload=i13renderWpRegisterCaptchaV2", function() {
							...
							if (typeof woo_wp_register_captcha_verified === "function") {
								 ...
								 woo_wp_register_captcha_verified(response);
										  ...
										  function i13renderWpRegisterCaptchaV2(){
												...
												try{
														myCaptcha= <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-wp-register-i13', {
														'sitekey': '<?php echo esc_html( $site_key ); ?>',
					...
					intval_wp_register_v3_ready(function () { 
												  ...
												  if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
													  ...
													  i13renderWpRegisterCaptchaV3();
															...
															jQuery.getScript("<?php echo esc_url( $this->i13_woo_get_recaptcha_js_url() ); ?>&render=<?php echo esc_html( $site_key ); ?>&onload=i13renderWpRegisterCaptchaV3", function() {
						...
						setInterval(function() {
														 ...
														 if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
								<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_wp_register_method_action_v3 ); ?>' }).then(function (token) {
				 ...
				 set_transient( 'i13_' . COOKIEHASH_I13 . '_woo_order_track', '1', $i13_recapcha_v2_timeout );
					   ...
					   wp_redirect( $current_url );
							 ...
							 wp_redirect( $current_url );
										...
										$data=array('event'=>array('token'=>$response,'siteKey'=>$site_key,'expectedAction'=>$i13_recapcha_woo_tracking_method_action_v3));
							 ...
							 $responseData = json_decode( $verifyResponse['body'] );
									...
									if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
										...
										if ( ( $responseData->riskAnalysis->score < $i13_recapcha_woo_tracking_score_threshold_v3 ) || ( $responseData->tokenProperties->action != $i13_recapcha_woo_tracking_method_action_v3 )) {
			...
			if ( 'yes' == $is_enabled ) {
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
							...
							if (jQuery("#woocommerce-order-tracking-nonce").length > 0){
									...
									if (typeof (window.grecaptcha) !== 'undefined' && typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> != 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && recaptcha_track_order_method === null) {
										...
										try{
												recaptcha_track_order_method = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render('g-recaptcha-order-track-method', {
												'sitekey': '<?php echo esc_html( $site_key ); ?>',
				...
				<?php endif; ?>
					...
					if (typeof (window.grecaptcha) !== 'undefined' && typeof grecaptcha != 'undefined' && typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> != 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.render) !== 'undefined' && recaptcha_track_order_method === null) {
				...
				<!-- do_not_format_javascript --><script type="text/javascript">
							...
							if (jQuery("#woocommerce-order-tracking-nonce").length > 0){
									...
									<?php endif; ?>
										jQuery("[name='track']").parent().prepend(`<input type="hidden" value="" name="i13_recaptcha_track_token_v3" id="i13_recaptcha_track_token_v3" />`);
												if (typeof grecaptcha == 'undefined' || typeof <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?> == 'undefined' || el_i13_track_order_captcha == null){
									...
									setInterval(function() {
																				...
																				if (typeof (window.grecaptcha) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>) !== 'undefined' && typeof (<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute) !== 'undefined') {
																						...
																						<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_woo_tracking_method_action_v3 ); ?>' }).then(function (token) {
					...
					if (jQuery("#woocommerce-order-tracking-nonce").length > 0){
							...
							<?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.ready(function () {
									...
									el_i13_track_order_captcha = <?php echo esc_html(I13_GRECAPTCHA_INSTANCE); ?>.execute('<?php echo esc_html( $site_key ); ?>', { action: '<?php echo esc_html( $i13_recapcha_woo_tracking_method_action_v3 ); ?>' }).then(function (token) {
	...
	public function checkCaptchaV3PPC($arrdata) {
		...
		$recapcha_error_msg_captcha_invalid = str_replace('[recaptcha]', ucfirst($captcha_lable_), $recapcha_error_msg_captcha_invalid);
			...
			if (isset($arrdata['recaptcha_token_v3']) && !empty($arrdata['recaptcha_token_v3'])) {
					...
					if (is_array($verifyResponse) && !is_wp_error($verifyResponse) && isset($verifyResponse['body'])) {
							...
							if ('' == trim($recapcha_error_msg_captcha_invalid)) {
								  ...
								  wp_send_json_error(
											array(
												...
												'message' => '<span id="g-recaptcha_error_v3"></span>' . __('Google reCAPTCHA verification failed, please try again later.', 'recaptcha-for-woocommerce'),
												'code' => 400,
											),
											400
									);
								  ...
								  wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v3"></span>' . $recapcha_error_msg_captcha_invalid,
												'code' => 400,
											),
											400
									);
						...
						if ('' == trim($recapcha_error_msg_captcha_no_response)) {
							   ...
							   wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v3"></span>' . __('Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce'),
												'code' => 400,
											),
											400
									);
								  ...
								  wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v3"></span>' . $recapcha_error_msg_captcha_no_response,
												'code' => 400,
											),
											400
									);
				...
				if ('' == trim($recapcha_error_msg_captcha_blank)) {
						...
						wp_send_json_error(
								array(
									'name' => 'i13_recaptcha_error',
									'message' => '<span id="g-recaptcha_error_v3"></span>' . __('Google reCAPTCHA token is missing.', 'recaptcha-for-woocommerce'),
									'code' => 400,
								),
								400
						);
					 ...
					 wp_send_json_error(
								array(
									'name' => 'i13_recaptcha_error',
									'message' => '<span id="g-recaptcha_error_v3"></span>' . $recapcha_error_msg_captcha_blank,
									'code' => 400,
								),
								400
						);
			...
			if (isset($arrdata['recaptcha_token']) && !empty($arrdata['recaptcha_token'])) {
					...
					if (is_array($verifyResponse) && !is_wp_error($verifyResponse) && isset($verifyResponse['body'])) {
						...
						if (!$responseData->success) {
							...
							if ('' == trim($recapcha_error_msg_captcha_invalid)) {
								  ...
								  wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v2"></span>' . __('Invalid recaptcha.', 'recaptcha-for-woocommerce'),
												'code' => 400,
											),
											400
									);
								  ...
								  wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v2"></span>' . $recapcha_error_msg_captcha_invalid,
												'code' => 400,
											),
											400
									);
						...
						if ('' == trim($recapcha_error_msg_captcha_no_response)) {
							   ...
							   wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v2"></span>' . __('Could not get response from reCAPTCHA server.', 'recaptcha-for-woocommerce'),
												'code' => 400,
											),
											400
									);
								  ...
								  wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v2"></span>' . $recapcha_error_msg_captcha_no_response,
												'code' => 400,
											),
											400
									);
						...
						if (isset($responseData->tokenProperties) && isset($responseData->tokenProperties->valid) && $responseData->tokenProperties->valid) {
							...
							if ('' == trim($recapcha_error_msg_captcha_invalid)) {
									...
									wp_send_json_error(
											array(
												'name' => 'i13_recaptcha_error',
												'message' => '<span id="g-recaptcha_error_v2"></span>' . __('Google reCAPTCHA verification failed, please try again later.', 'recaptcha-for-woocommerce'),
												'code' => 400,
											),
											400
									);
				...
				if ('' == trim($recapcha_error_msg_captcha_blank)) {
						...
						wp_send_json_error(
								array(
									'name' => 'i13_recaptcha_error',
									'message' => '<span id="g-recaptcha_error_v2"></span>' . __('Google reCAPTCHA token is missing.', 'recaptcha-for-woocommerce'),
									'code' => 400,
								),
								400
						);
					 ...
					 wp_send_json_error(
								array(
									'name' => 'i13_recaptcha_error',
									'message' => '<span id="g-recaptcha_error_v2"></span>' . $recapcha_error_msg_captcha_blank,
									'code' => 400,
								),
								400
						);
