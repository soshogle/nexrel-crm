	...
	<div class="nextgen-gallery-onboarding-wizard-body">
		...
		<div class="actions">
			<div class="">
				...
				<div class="content">
					<div><a target="_blank" href="<?php echo esc_url( 'https://www.imagely.com/docs/nextgen-gallery/?utm_source=WordPress&utm_campaign=nextgen-galleryliteplugin&utm_medium=nextgen-gallery-wizard-success' ); ?>" title="<?php esc_attr_e( 'Read our Step by Step Guide to Create and Share your Gallery', 'nggallery' ); ?>" ><?php esc_html_e( 'Read Our Step-by-Step Guide to Create and Share Your Gallery', 'nggallery' ); ?></a></div>
				</div>
			</div>
			<div class="">
				<div class="icon">
