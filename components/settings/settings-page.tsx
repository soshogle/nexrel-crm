...
export function SettingsPage({ session }: SettingsPageProps) {
  ...
  const settingsSections = [
    ...
    { id: "onboarding-wizard", label: "Onboarding Wizard", icon: Rocket },
    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0">
          {activeSection === "billing" && <BillingUpgradeCard />}

          {activeSection === "onboarding-wizard" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Re-open onboarding to update your setup steps and launch
                  configuration
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild>
                  <a href="/onboarding">Open Onboarding Wizard</a>
                </Button>
              </CardContent>
            </Card>
          )}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      This will be displayed in your booking widget and
                      communications
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Your complete business address (start typing for
                      suggestions)
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      A brief description of your business (used by AI assistant
                      for context)
                    </p>
                  </div>
                ...
                <Button
                  ...
                  disabled={
                    isSavingProfile || isLoadingProfile || !companyName.trim()
                  }
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure your Google Places API key to search for business
                    leads
                  </CardDescription>
                </CardHeader>
          ...
          {activeSection === "google-workspace" && <GoogleWorkspaceSettings />}

          {activeSection === "social-media" && <SocialMediaSettings />}

          {activeSection === "calendars" && <CalendarConnections />}

          {activeSection === "booking-widget" && <BookingWidgetSettings />}

          {activeSection === "subdomain" && <SubdomainSettings />}

          {activeSection === "messaging" && <MessagingConnections />}

          {activeSection === "meta" && <MetaSettings />}

          {activeSection === "whatsapp" && <WhatsAppSettings />}

          {activeSection === "quickbooks" && <QuickBooksSettings />}

          {activeSection === "knowledge-base" && <KnowledgeBaseSettings />}

          {activeSection === "auto-reply" && <AutoReplySettings />}

          {activeSection === "language" && <LanguageSelector />}

          {activeSection === "permissions" && <PermissionsManager />}

          {activeSection === "ehr-bridge" && <EHRBridgeSettings />}
        </div>
      </div>
    </div>
  );
