...
const merchantItems = [
  ...
  {
    id: "agent-command-center" as MenuItemId,
    title: "Agent Command Center",
    href: "/dashboard/agent-command-center",
    icon: Rocket,
  },
  {
  ...
  {
    id: "inquiry-analytics" as MenuItemId,
    title: "Inquiry Analytics",
    href: "/dashboard/real-estate/inquiry-analytics",
    icon: TrendingUp,
  },
  {
  ...
  {
    id: "blog-management" as MenuItemId,
    title: "Blog",
    href: "/dashboard/blog",
    icon: Sparkles,
  },
...
export function SidebarNav({ isExpanded }: SidebarNavProps) {
  ...
  const translateMenuItem = (itemId: string, fallbackTitle: string): string => {
    const translationMap: Record<string, string> = {
      dashboard: "dashboard",
      "agent-command-center": "agentCommandCenter",
      "ai-brain": "aiBrain",
      ...
      "inquiry-analytics": "inquiryAnalytics",
      templates: "templates",
  ...
  const [pendingAdminRoute, setPendingAdminRoute] = useState<string | null>(
    null,
  );
  ...
  const handleLogout = async () => {
    ...
    if (displaySession?.user?.isImpersonating) {
      try {
        ...
        if (sessionToken) {
          await fetch(
            `/api/platform-admin/impersonate?sessionToken=${sessionToken}`,
            {
              method: "DELETE",
            },
          );
