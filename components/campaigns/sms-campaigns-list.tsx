...
import { CreateSmsCampaignDialog } from './create-sms-campaign-dialog';
...
export function SmsCampaignsList() {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/campaigns/sms/${deleteId}`, {
        method: 'DELETE',
      });
  ...
  const handleSend = async (id: string) => {
    setSendingId(id);
    try {
      const response = await fetch(`/api/campaigns/sms/${id}/send`, {
        method: 'POST',
      });
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center mb-4">
                Create your first SMS campaign to start engaging with your audience
              </p>
              <Button onClick={() => setShowCreateDialog(true)}>
                <Plus className="h-4 w-4 mr-2" />
                Create Campaign
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{campaign.repliedCount}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{getReplyRate(campaign)}</p>
                      </div>
                    </div>
                  </div>
