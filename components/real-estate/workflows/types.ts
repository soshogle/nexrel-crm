...
export interface WorkflowTask {
  ...
  name: string;
  description: string;
  taskType: 'QUALIFICATION' | 'MLS_SEARCH' | 'SHOWING_SCHEDULE' | 'SHOWING_FEEDBACK' | 'OFFER_PREP' | 'OFFER_SUBMIT' | 'CONDITION_TRACKING' | 'CLOSING_COORDINATION' | 'POST_CLOSE_FOLLOWUP' | 'CMA_GENERATION' | 'LISTING_PREP' | 'PHOTO_SCHEDULING' | 'MARKETING_DRAFT' | 'LISTING_PUBLISH' | 'LISTING_VISIT_CONFIRMED' | 'OUTREACH' | 'SHOWING' | 'OFFER' | 'NEGOTIATION' | 'INSPECTION' | 'APPRAISAL' | 'FINANCING' | 'CLOSING' | 'POST_CLOSE' | 'LISTING' | 'MARKETING' | 'STAGING' | 'OPEN_HOUSE' | 'CUSTOM';
