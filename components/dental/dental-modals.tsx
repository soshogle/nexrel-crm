      ...
      >
        <div className="space-y-3">
          <div className="flex items-center gap-2 mb-4">
            <Input
              placeholder="Search..."
              className="h-8 flex-1 border border-gray-300"
            />
        ...
        <div className="space-y-3">
          ...
          {displayFormResponses.map((response, idx) => (
            ...
            >
              ...
              <Badge className="bg-green-100 text-green-700 text-sm border-0">
                Submitted
              </Badge>
            </div>
          ))}
        ...
        {sessionUserId ? (
          <div className="text-center space-y-6 py-8">
            ...
            <Input
              ...
              className="mb-4 border border-gray-300 h-10"
            />
            <div className="flex gap-3">
              <Button
                className="bg-purple-600 hover:bg-purple-700 text-white flex-1 h-10"
                onClick={onCheckInCurrentPatient}
              >
                Check-In
              </Button>
              <Button variant="outline" className="border-gray-300 flex-1 h-10">
                Update Info
              </Button>
            </div>
          </div>
