...
export async function POST(request: NextRequest) {
  try {
    ...
    // Get item details
    const item = await db.generalInventoryItem.findUnique({
    ...
    const client = createPlatformClient(
      settings.platform as "shopify" | "woocommerce",
      {
        ...
        woocommerceConsumerSecret:
          settings.woocommerceConsumerSecret || undefined,
      },
    );
    ...
    await db.ecommerceSyncSettings.update({
