...
// POST - Generate email campaign from natural language
export async function POST(request: NextRequest) {
  try {
    ...
    const campaign = await aiCampaignGenerator.generateEmailCampaign({
      description,
      campaignType: 'email',
      targetAudience,
      tone,
    ...
    return apiErrors.internal('Failed to generate email campaign');
  }
}
