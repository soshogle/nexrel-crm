          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 space-y-8">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                Soshogle ("we," "our," or "us") is committed to protecting your
                privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you use our
                AI-powered CRM platform and services.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                <li>
                  ...
                  phone number, business name, and password
                </li>
                <li>
                  <strong>Business Data:</strong> Customer contacts, leads,
                  deals, appointments, and communication history
                </li>
                <li>
                ...
                <li>
                  <strong>Communications:</strong> Emails, SMS messages, call
                  recordings, and transcripts when you use our platform
                </li>
              </ul>
              ...
              <p className="text-gray-300 leading-relaxed">
                When you connect third-party services (Gmail, Google Calendar,
                Soshogle Call, Soshogle Voice AI), we collect data necessary for
                these integrations to function, in accordance with their
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                ...
                <li>
                  Enable AI-powered voice agents, chat assistants, and
                  automation
                </li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                <li>
                  <strong>Voice AI Agents:</strong> Process call audio and
                  generate transcripts using Soshogle Voice AI
                </li>
                <li>
                  <strong>Chat Assistant:</strong> Analyze conversations to
                  provide intelligent responses
                </li>
                <li>
                  <strong>Task Automation:</strong> Suggest tasks, categorize
                  activities, and optimize workflows
                </li>
                <li>
                  <strong>Campaign Generation:</strong> Create personalized
                  marketing content
                </li>
              </ul>
              <p className="text-gray-300 leading-relaxed mt-4">
                All AI processing is conducted securely, and we do not use your
                data to train third-party AI models without your explicit
                consent.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                <li>
                  <strong>Service Providers:</strong> Soshogle Call (phone/SMS),
                  Soshogle Voice AI (voice AI), Google (email/calendar), Stripe
                  (payments), AWS (cloud storage)
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                will delete or anonymize your data within 90 days, except where
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed mt-4">
                ...
                <a
                  href="mailto:privacy@soshogle.com"
                  className="text-purple-400 hover:text-purple-300"
                >
                  privacy@soshogle.com
                </a>
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                If you are in Canada, we handle personal information under the
                Personal Information Protection and Electronic Documents Act
                (PIPEDA), and applicable provincial privacy laws. You may
                request access to your personal data, request corrections, and
                ask questions about how your information is collected, used,
                disclosed, and safeguarded.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                notice on our platform. Your continued use of our services after
