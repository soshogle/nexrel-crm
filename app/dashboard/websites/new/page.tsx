        ...
        <div className="relative z-10 container mx-auto p-6 max-w-2xl">
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-xl border-2">
            ...
            <CardContent className="space-y-4">
              ...
              {/* Add Blog Section (rebuild templates may not include blog) */}
              <Card className="border-2 border-purple-200">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="rebuildEnableBlog"
                      checked={enableBlog}
                      onCheckedChange={(checked) => setEnableBlog(!!checked)}
                    />
                    <Label htmlFor="rebuildEnableBlog" className="cursor-pointer">
                      Enable blog page
                    </Label>
                  </div>
                  {enableBlog && (
                    <div className="pl-6 space-y-3 border-l-2 border-purple-200">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="rebuildBlogHasCTA"
                          checked={blogHasCTA}
                          onCheckedChange={(checked) => setBlogHasCTA(!!checked)}
                        />
                        <Label htmlFor="rebuildBlogHasCTA" className="cursor-pointer text-sm">
              ...
              {/* SEO Automation (Optional) - Rebuild */}
