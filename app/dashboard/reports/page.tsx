...
export default function ReportsPage() {
  ...
  const safeTimeAgo = (value: unknown): string => {
    try {
      const date = new Date(
      ...
      if (res.ok) {
          ...
          .map((r: any) => ({
            ...
            title:
              typeof r.title === "string" && r.title.trim()
                ...
                : "Untitled report",
            reportType:
              typeof r.reportType === "string" && r.reportType.trim()
                ? r.reportType
                : "custom",
        ...
        if (reportList.length > 0) {
          const toSelect = reportIdFromUrl
            ? reportList.find((r: any) => r.id === reportIdFromUrl) ||
              reportList[0]
            : reportList[0];
  ...
  const renderReportContent = (content: any) => {
    ...
    if (typeof content !== "object") {
      return (
        <p className="text-gray-600 whitespace-pre-wrap">{String(content)}</p>
      );
    }
    ...
    return (
      <div className="space-y-6">
        ...
        {content.agentStats &&
          Array.isArray(content.agentStats) &&
          content.agentStats.length > 0 && (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {agent.totalCalls} calls · {agent.campaigns}{" "}
                            campaigns · {agent.aiEmployees} AI employees
                          </p>
                        </div>
                      </div>
            ...
            {Object.entries(content.metrics).map(([key, value], idx) => (
              <div
                ...
                className={cn(
                  ...
                  idx % 3 === 0 &&
                    "border-purple-200/50 bg-gradient-to-br from-white/90 to-purple-50/30",
                  idx % 3 === 1 &&
                    "border-blue-200/50 bg-gradient-to-br from-white/90 to-blue-50/30",
                  idx % 3 === 2 &&
                    "border-pink-200/50 bg-gradient-to-br from-white/90 to-pink-50/30",
                )}
              >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2 text-lg">
              AI-generated reports from your assistant. Ask the AI to create
              reports like &quot;Generate a sales report for last month&quot;.
            </p>
          </div>
          <Button
              ...
              {reports.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Ask the AI assistant to create a report
                  </p>
                  <p className="text-xs text-purple-600 mt-1 font-medium">
                    e.g. &quot;Generate a sales report for last month&quot;
                  </p>
                </div>
              ) : (
                  ...
                  <CardDescription>
                    {selectedReport && (
                      <>
                        ...
                        {selectedReport.period || "All time"} •{" "}
                        {safeTimeAgo(selectedReport.createdAt)}
                      </>
                    )}
                  </CardDescription>
                </div>
              ...
              {selectedReport ? (
                ...
                <div className="flex flex-col items-center justify-center py-24">
                  ...
                  <p className="text-gray-600">
                    Select a report from the list or create one via the AI
                    assistant
                  </p>
                  <p className="text-sm text-purple-600 mt-2 font-medium">
                    Try: &quot;Generate a sales report for last month&quot;
                  </p>
                </div>
              )}
            </CardContent>
