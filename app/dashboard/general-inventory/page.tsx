    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50/50 via-white to-pink-50/50 relative overflow-hidden">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2 flex-wrap">
          <Button variant="outline" onClick={() => setShowLowStockAlertsDialog(true)} className="gap-2 border-purple-200 text-gray-700 hover:bg-purple-50">
            <Bell className="h-4 w-4" />
            Alerts
          </Button>
          <Button variant="outline" onClick={() => setShowBarcodeSearchDialog(true)} className="gap-2 border-purple-200 text-gray-700 hover:bg-purple-50">
            <Barcode className="h-4 w-4" />
            Barcode Search
          </Button>
          {isAdmin && (
            <>
              <Button variant="outline" onClick={() => setShowEcommerceSyncDialog(true)} className="gap-2 border-purple-200 text-gray-700 hover:bg-purple-50">
                <RefreshCw className="h-4 w-4" />
                E-commerce Sync
              </Button>
              <Button variant="outline" onClick={() => setShowReportsDialog(true)} className="gap-2 border-purple-200 text-gray-700 hover:bg-purple-50">
                <BarChart3 className="h-4 w-4" />
                Reports
              </Button>
              <Button variant="outline" onClick={handleExport} className="gap-2 border-purple-200 text-gray-700 hover:bg-purple-50">
                <Download className="h-4 w-4" />
                Export
              </Button>
              <Button variant="outline" onClick={() => setShowBulkImportDialog(true)} className="gap-2 border-purple-200 text-gray-700 hover:bg-purple-50">
      ...
      <Tabs defaultValue="items" className="space-y-4">
        <TabsList className="bg-white/80 border border-purple-200 backdrop-blur-sm">
          <TabsTrigger value="items" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-gray-600">
            <Package className="h-4 w-4 mr-2" />
            Items
          </TabsTrigger>
          <TabsTrigger value="categories" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-gray-600">
            <FolderTree className="h-4 w-4 mr-2" />
            Categories
          </TabsTrigger>
          <TabsTrigger value="suppliers" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-gray-600">
            <Truck className="h-4 w-4 mr-2" />
            Suppliers
          </TabsTrigger>
          <TabsTrigger value="locations" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-gray-600">
            <MapPin className="h-4 w-4 mr-2" />
            Locations
          </TabsTrigger>
          {isAdmin && (
            <TabsTrigger value="ecommerce" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-gray-600">
              <Package className="h-4 w-4 mr-2" />
              E-Commerce Sync
            </TabsTrigger>
          )}
        ...
        <TabsContent value="categories" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {categories.map((category) => (
              <Card key={category.id} className="border-2 border-purple-200/50 bg-white/80 backdrop-blur-sm shadow-sm hover:border-purple-300 transition-colors">
                <CardHeader>
        ...
        <TabsContent value="locations" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {locations.map((location) => (
              <Card key={location.id} className="border-2 border-purple-200/50 bg-white/80 backdrop-blur-sm shadow-sm hover:border-purple-300 transition-colors">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="text-gray-900">{location.name}</CardTitle>
                      {location.type && (
                        <CardDescription className="text-gray-600">
                          {location.type}
                        </CardDescription>
