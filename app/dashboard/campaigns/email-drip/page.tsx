...
import { Plus, Search, Filter, TrendingUp, Users, Mail, Clock } from 'lucide-react';
...
export default function EmailDripCampaignsPage() {
  ...
  const stats = {
    ...
    avgOpenRate: campaigns.length > 0
      ? campaigns.reduce((sum, c) => sum + c.avgOpenRate, 0) / campaigns.length
      : 0,
  };
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Email Drip Campaigns</h1>
          <p className="text-gray-500 mt-1">Create and manage automated email sequences</p>
        </div>
        <Button
          onClick={() => router.push('/dashboard/campaigns/email-drip/create')}
          ...
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              {searchQuery || statusFilter !== 'all'
                ...
                : 'Create your first email drip campaign to get started'}
            </p>
            {!searchQuery && statusFilter === 'all' && (
              <Button
                onClick={() => router.push('/dashboard/campaigns/email-drip/create')}
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredCampaigns.map((campaign) => (
            <Card
              ...
              onClick={() => router.push(`/dashboard/campaigns/email-drip/${campaign.id}`)}
            >
              <CardContent className="pt-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge variant="outline" className="text-xs">
                        {campaign._count?.sequences || 0} emails
                      </Badge>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{campaign.avgOpenRate.toFixed(1)}%</p>
                      </div>
                      <div>
                        <p className="text-gray-500">Click Rate</p>
                        <p className="font-semibold text-gray-900">{campaign.avgClickRate.toFixed(1)}%</p>
                      </div>
                    </div>
                  </div>
                </div>
