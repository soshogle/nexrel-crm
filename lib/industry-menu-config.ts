...
const CORE_MENU_ITEMS: MenuItemId[] = [
  ...
  "blog-management", // Blog post management
...
const INDUSTRY_MENU_CONFIG: Record<Industry, MenuItemId[]> = {
  ...
  REAL_ESTATE: [
    ...
    "inquiry-analytics", // Lead attribution and inquiry tracking
  ],
  ...
  ACCOUNTING: [...CORE_MENU_ITEMS, "payments", "widgets"],
  LAW: [...CORE_MENU_ITEMS, "payments", "widgets"],
  ORTHODONTIST: [
    ...CORE_MENU_ITEMS,
...
export function getAllFeatures(): {
  ...
  return [
    ...
    { id: "blog-management", label: "Blog Management", category: "Core CRM" },
