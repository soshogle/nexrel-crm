 ...
 *
 * User operations use main prisma (not industry DB) because User is a global entity
...
- nexrel_ai_operate: Nexrel AI orchestration command for advanced automation modes. Use this for end-to-end chains, approval-by-voice, daily command center, meeting/call intelligence, performance coaching, vertical playbooks, autonomous mode policy, team delegation, and customer-facing voice workflows.
...
For complex Nexrel AI tasks, call nexrel_ai_operate with the right mode:
      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            contactName: {
              type: "string",
              description: "Contact name for chain or call intelligence modes",
            },
            email: { type: "string", description: "Contact email (optional)" },
            phone: { type: "string", description: "Contact phone (optional)" },
            company: {
              type: "string",
              description: "Company name for contact/deal chain (optional)",
            },
            decision: {
              type: "string",
              description: "For approval_voice mode: list, approve, reject",
              enum: ["list", "approve", "reject"],
            },
            jobId: {
              type: "string",
              description: "AI Job ID for approval_voice approve/reject",
            },
            phase: {
              type: "string",
              description:
                "For meeting_call_intelligence: pre_call or post_call",
              enum: ["pre_call", "post_call"],
            },
            callSummary: {
              type: "string",
              description: "Post-call summary text",
            },
            nextAction: {
              type: "string",
              description: "Post-call next action task title",
            },
            vertical: {
              type: "string",
              description: "For vertical_playbook: dental or real_estate",
              enum: ["dental", "real_estate"],
            },
            workflowName: {
              type: "string",
              description: "Optional workflow name for playbook modes",
            },
            enabled: {
              type: "boolean",
