...
import { RETAIL_EMPLOYEE_CONFIGS } from "./retail/config";
import { RETAIL_EMPLOYEE_PROMPTS } from "./retail/prompts";

const DENTAL_EMPLOYEE_TYPES = Object.keys(
  DENTAL_EMPLOYEE_CONFIGS,
) as DentistAIEmployeeType[];

const DENTAL_MODULE: IndustryAIEmployeeModule = {
  industry: "DENTIST",
  employeeTypes: DENTAL_EMPLOYEE_TYPES,
  configs: DENTAL_EMPLOYEE_CONFIGS as Record<
    string,
    import("./types").IndustryEmployeeConfig
  >,
  prompts: DENTAL_EMPLOYEE_PROMPTS as Record<
    string,
    import("./types").IndustryEmployeePrompt
  >,
...
const RETAIL_MODULE: IndustryAIEmployeeModule = {
  industry: "RETAIL",
  employeeTypes: Object.keys(RETAIL_EMPLOYEE_CONFIGS),
  configs: RETAIL_EMPLOYEE_CONFIGS,
  prompts: RETAIL_EMPLOYEE_PROMPTS,
  fieldLabels: { contact: "Customer", deal: "Order" },
};

export const INDUSTRY_AI_EMPLOYEE_REGISTRY: Partial<
  Record<Industry, IndustryAIEmployeeModule>
> = {
...
export function hasIndustryAIEmployees(
